...
if(NOT "${OPENCV_DIR}" STREQUAL "" AND NOT "${OpenCV_DIR}")
  message(DEBUG "OPENCV_DIR: ${OPENCV_DIR}")
...
if(OpenCV_DIR)
    ...
    set(OpenCV_DIR "OpenCV_DIR-NOTFOUND" CACHE PATH "OpenCV installation directory" FORCE)
endif()
